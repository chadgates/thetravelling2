# -*- coding: utf-8 -*-
"""
Django settings for The Travelling 2 project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (projthetravelling/config/settings/common.py - 3 = projthetravelling/)
APPS_DIR = ROOT_DIR.path('projthetravelling')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'projthetravelling.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///projthetravelling'),
}
...
ACCOUNT_ADAPTER = 'projthetravelling.users.adapters.AccountAdapter'
